...
import { trackAddToCart, trackViewProduct, trackWhatsAppClick } from "@/lib/analytics";
...
export function ProductDetailClient({ product }: ProductDetailClientProps) {
  ...
  return (
    <>
      <VisitorTracker pageType="product" />
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xl font-bold text-primary">
              {formatCurrency(
                (Number.isFinite(discountNum) ? discountNum : (Number.isFinite(priceNum) ? priceNum : 0)) * quantity
              )}
            </p>
          </div>
          <Button
